 ...
 */
public class CustomTextView_med extends android.support.v7.widget.AppCompatTextView {

    public CustomTextView_med(Context context) {
        this(context, null);
    }

    public CustomTextView_med(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (path_font != null) {
            ...
            setCustomTypeFace(context, "fonts/AvenirNextLTPro-MediumCnIt.otf");
        }
    }
